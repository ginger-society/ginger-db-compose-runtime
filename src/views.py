...
def get_model_db_schemas(
    models_to_render, orm
):  # noqa: C901 # pylint: disable=R0915,R0912,R0914
    """
        ...
        for field, field_def in field_items:
            ...
            if (
                ...
                and (
                    ...
                    or (
                        hasattr(field_def, "field")
                        and isinstance(field_def.field, ManyToManyField)
                    )
                )
            ):
                on_delete = None
                ...
                if isinstance(field_def.field, ForeignKey):
                    if "rel" in field_def.__dict__:
                        ...
                        target_model_name = str(field_def.__dict__["field"]).split(".")[
                            1
                        ]
                        ...
                        target_model_name = str(field_def.field.target_field).split(
                            "."
                        )[1]
                        ...
                        target_table_name = (
                            field_def.field.target_field.model._meta.db_table
                        )
                ...
                if hasattr(field_def.field, "auto_now"):
                    schema_obj[model.__name__]["fields"][field][
                        "auto_now"
                    ] = field_def.field.auto_now
                    schema_obj[model.__name__]["fields"][field][
                        "auto_now_add"
                    ] = field_def.field.auto_now_add

                if orm == "py-sqlalchemy":
                    schema_obj[model.__name__]["fields"][field]["pydenticType"] = (
                        LANG_TYPE_MAPPER[orm][field_def.field.__class__.__name__]
                    )

                    schema_obj[model.__name__]["fields"][field][
                        "pydentic_class_type"
                    ] = PYDENTIC_TYPE_MAPPER[field_def.field.__class__.__name__]
                ...
                if orm == "rust-diesel":
                    schema_obj[model.__name__]["fields"][field]["rustType"] = (
                        LANG_TYPE_MAPPER[orm][field_def.field.__class__.__name__]
                    )

                if field_def.field.default.__class__ != type and not callable(
                ...
                if field_def.field.choices:
                    ...
                    schema_obj[model.__name__]["fields"][field][
                        "choices"
                    ] = field_def.field.choices

                    if orm == "typeORM":
                        schema_obj[model.__name__]["exports"].append(field + "Enum")
                        ...
                        if not isinstance(field_def.field.default, type):
                            choice_field_decorator_input["default"] = (
                                field + "Enum." + field_def.field.default
                            )
                        schema_obj[model.__name__]["fields"][field][
                            "decorators"
                        ].append(
                        ...
                        schema_obj[model.__name__]["fields"][field]["type"] = (
                            field + "Enum"
                        )
                    elif orm == "py-sqlalchemy":
                        schema_obj[model.__name__]["fields"][field]["type"] = (
                            "Enum(" + title(field) + "Enum)"
                        )
                    ...
                    if orm == "typeORM":
                        schema_obj[model.__name__]["fields"][field][
                            "decorators"
                        ].append({"tag": "PrimaryGeneratedColumn"})
                    elif orm == "py-sqlalchemy":
                        schema_obj[model.__name__]["fields"][field][
                            "decorators"
                    ...
                    if hasattr(field_def, "rel") and field_def.rel.model is model:
                        ...
                        target_model_name = str(
                            field_def.rel.related_model.__name__
                        ).split(".")[
                            -1
                    ...
                    if not related_name:
                        related_name = model.__name__.split(".")[-1].lower() + "_set"

                    # print('------' , target_model_name, anchor_model)
                    if orm == "typeORM":
                        schema_obj[model.__name__]["fields"][field]["type"] = (
                            title(target_model_name) + "Entity"
                        )
                        ...
                        if (
                            relation_decorator
                            not in schema_obj[model.__name__]["relation_imports"]
                        ):
                        ...
                        if anchor_model:
                            schema_obj[model.__name__]["fields"][field][
                            ...
                            ].append(
                                {
                                    ...
                                    "inputStr": json.dumps(
                                        {
                                            "name": model.objects.model._meta.db_table
                                            + "_"
                                            + field,
                                            "joinColumn": {
                        ...
                        schema_obj[model.__name__]["fields"][field][
                            "decorators"
                        ].append('back_populates="' + related_name + '"')
                        schema_obj[model.__name__]["fields"][field]["pydenticType"] = (
                            "list[" + '"' + title(target_model_name) + '"' + "]"
                        )

                        schema_obj[model.__name__]["fields"][field][
                            "pydentic_class_type"
                        ] = ("list[" + '"' + title(target_model_name) + 'T"' + "]")
                            ...
                            schema_obj[model.__name__]["relation_tables"].append(
                                {
                                    ...
                                    + "_"
                                    + field,
                                    "self_id_path": model.objects.model._meta.db_table
                                    + ".id",
                        ...
                        if (
                            relationshipStr
                            not in schema_obj[model.__name__]["relation_tables"]
                            and target_model_name
                            not in schema_obj[model.__name__]["rust_related_models"]
                        ):
                            schema_obj[model.__name__]["relation_tables"].append(
                                relationshipStr
                            )
                    ...
                    if orm == "typeORM":
                        schema_obj[model.__name__]["fields"][field]["type"] = (
                            target_model_name.capitalize() + "Entity"
                        )
                        ...
                        if (
                            "Associations"
                            not in schema_obj[model.__name__]["rust_derive"]
                        ):
                ...
                if orm == "typeORM":
                    if (
                        len(schema_obj[model.__name__]["fields"][field]["decorators"])
                        == 0
                    ):
...
models_parameter = openapi.Parameter(
    "models",
    openapi.IN_QUERY,
    description="Models in csv format",
...
def ts_models(models_to_render):
    ...
    # print(schemas)
    rendered_index = render_to_string("index.template", {"data": schemas.items()})
                ...
                enums_to_render.append(
                    {
                        ...
                        "trsnaform_enum": field_value["trsnaform_enum"],
                    }
                )
    ...
    rendered_models.append({"file_name": "index.ts", "file_content": rendered_index})
...
def rust_diesel_models(models_to_render):
    ...
    print(schemas, enums_to_render, relation_tables_to_render)
    ...
    rendered_files.append({"file_name": "schema.rs", "file_content": rendered_models})
...
def ginger_dj_models(models_to_render):
    ...
    rendered_files.append({"file_name": "models.py", "file_content": rendered_models})
